...
from scipy.stats import binom_test  # Using binom/chi2 instead of mcnemar for pure python simplicity in mock
...
async def _async_nightly_evaluation():
    async with SessionLocal() as db:
        ...
        if gate1_f1 and gate2_roc and gate3_latency and gate4_significance:
            ...
            logger.info(f"All gates passed! Promoting {challenger.version_name} to CHAMPION.")
